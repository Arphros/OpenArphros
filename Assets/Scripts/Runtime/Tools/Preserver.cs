...
namespace Arphros
{
    public class PreservedGameObject
    {
        ...
        public PreservedGameObject() { }
        public PreservedGameObject(GameObject obj)
        {
            lastGameObject = obj;
            ...
            foreach (var comp in components)
            {
                try
                {
                    ...
                    cache.cache = new PreserverCache(comp, comp.GetType());
        ...
        public void ApplyToGameObject() => ApplyToGameObject(lastGameObject);
        ...
        public class CachedComponent
        {
            ...
            public PreserverCache cache;
        }
    }

    public class PreserverCache
    {
        public List<SourceTemp> sources = new List<SourceTemp>();

        public PreserverCache() { }
        public PreserverCache(object source, Type mainType, Type excludedType = null)
        {
